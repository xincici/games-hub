export default {
  en: {
    ...
    help3: 'Turn on the robot in the upper left corner, which will automatically fill in 1234 for you and make a judgment when a new game is started.',
  ...
  cn: {
    ...
    help3: '左上角开启机器人，将在开始游戏时自动替你填入 1234 并进行判断',
    confirmText: '好的，明白',
    tipWin: '你赢了',
    tipLost: '你输了',
    anwserIs: '答案是: ',
