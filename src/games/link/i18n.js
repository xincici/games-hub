export default {
  en: {
    ...
    confirmMsg: 'Your level record will be cleared and you will start again from level 1. To retry the level you are on, use Replay Level instead.',
  ...
  cn: {
    ...
    confirmMsg: '会清除闯关记录并从第 1 关重新开始。如果只是想再来一次本关，请点遮罩上的「重玩本关」。',
    confirmOk: '从头开始',
    cancel: '取消',
    helpTip: '查看帮助',
