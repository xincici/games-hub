export default {
  en: {
    ...
    help1: 'Each level sets its own board size, emoji variety, tile count, walls and time limit — from a 6×6 board with 9 pairs up to 9 columns and 12 rows with 30 pairs, 12 kinds and 18 walls. Level 30 is the hardest setting; levels themselves never end.',
  ...
  cn: {
    ...
    help1: '每一关的棋盘大小、emoji 种类、牌数、墙数与限时都不同：从 6×6、9 对开始，最高到 9 列 × 12 行、30 对、12 种 emoji 配 18 面墙。第 30 关起难度封顶，关数无限。',
